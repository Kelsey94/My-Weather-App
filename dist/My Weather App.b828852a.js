...
function dynamicTextSize() {
    ...
    if (textLength < 10) cityDisplayElement.style.fontSize = '42px';
    else if (textLength >= 10 && textLength < 20) cityDisplayElement.style.fontSize = '32px';
    else cityDisplayElement.style.fontSize = '22px';
}

},{}]},["93v64","lhpGb"], "lhpGb", "parcelRequirefa2e", {})

//# sourceMappingURL=My Weather App.b828852a.js.map
